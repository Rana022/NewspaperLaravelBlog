            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <span><a class="btn btn-sm btn-primary pull-right" href="{{route('admin.tag.index')}}">Show Tag</a></span>
                  <div class="card-body">
                  <form action="{{route('admin.tag.update', $tag->id)}}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tag Name</label>
